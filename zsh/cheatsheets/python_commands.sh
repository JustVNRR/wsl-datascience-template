...
# requires: uv
# ==========================================
# Offered only while uv is installed - which is to say, while the python pack
# is. An instance without it has no uv at all, and none of these commands would
# run: the header is what keeps them off the picker.
